...
abstract class Factory
{
     ...
     * @return EloquentCollection<int, Model|TModel>
     */
     ...
     * @param (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed> $attributes
     * @param Model|null $parent
     * @return EloquentCollection<int, Model|TModel>|Model|TModel
     */
     ...
     * @param Model|null $parent
     * @return \Closure(): (EloquentCollection<int, Model|TModel>|Model|TModel)
     */
...
//            return $this->for->isEmpty() ? $states : new Collection(array_merge([function () {
            return $this->for->isEmpty() ? $states : \app(Collection::class, [
                array_merge([
                    function () {
    ...
    /**
     * Add a new sequenced state transformation to the model definition and update the pending creation count to the
     ...
     *
     * @param \Illuminate\Database\Eloquent\Factories\Factory|\Illuminate\Support\Collection|Model|array $factory
     ...
     *
     * @param \Illuminate\Database\Eloquent\Factories\Factory|Model $factory
     * @param string|null $relationship
     * @return static
     */
     ...
     *
     * @param Model|\Illuminate\Support\Collection|array $model
     * @return static
     */
     ...
     *
     * @param \Closure(Model|TModel): mixed $callback
     * @return static
     */
     ...
     *
     * @param \Closure(Model|TModel, Model|null): mixed $callback
     * @return static
     */
     ...
     *
     * @param callable(self): class-string<Model|TModel> $callback
     * @return void
     */
     ...
     *
     * @param callable(class-string<Model>): class-string<\Illuminate\Database\Eloquent\Factories\Factory> $callback
     * @return void
     */
        ...
        if (str_starts_with($method, 'for')) {
            ...
            return $this->has(
                $factory
                    ...
                    ->state(
                        (is_callable($parameters[0] ?? null) || is_array(
                            $parameters[0] ?? null
